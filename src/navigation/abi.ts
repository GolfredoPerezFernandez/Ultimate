		...
		"outputs": [
			{
				...
				"internalType": "struct UltimateMaster.PoolInfo",
				"name": "pool",
				"type": "tuple"
			}
		],
...
export const marketplace3=[
	...
	},
	{
		"inputs": [
			{
				...
				"internalType": "struct NFTAuctionPermit.NewAuctionRequest",
				"name": "_newAuction",
				"type": "tuple"
			},
			{
		...
		"name": "authorizedAuctionCreation",
		"outputs": [],
		"stateMutability": "nonpayable",
		"type": "function"
	},
		...
		"inputs": [
			{
				"components": [
					...
					{
						"internalType": "enum SemiFungibleNFTAuction.AUCTION_STATUS",
						"name": "status",
						"type": "uint8"
					}
				],
				"indexed": false,
				"internalType": "struct SemiFungibleNFTAuction.Auction",
				"name": "auction",
				"type": "tuple"
			},
			{
	...
	},
	{
		...
		"name": "getActiveAuctionHashesByHolder",
		"outputs": [
			{
				"components": [
					{
