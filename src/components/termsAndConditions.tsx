    ...
    <Box>
      ...
      <Box >
        ...
        <Stack>
          ...
          sx={{fontFamily: props.fontFamily, color: props.color, fontSize: props.fontSize, cursor:'pointer' }}>
            {props.name}
      ...
      <Dialog
        ...
        sx={{
          ...
          '&:hover': {  
            border: '1px solid rgba(255, 255, 255, 0.3)',
            boxShadow: '0 2px 3px 0 rgba( 255, 255, 255, 0.3 )'
          },
      ...
      >
        ...
        <DialogContent dividers={scroll === 'paper'}>
          ...
          >
            ...
            <p>
            along with our Company Privacy Policy (__________________________________ [Privacy Policy URL]), 
            constitutes a legally binding agreement made between you, whether personally or on behalf of an entity (“user” or “you”) and  NFT  and its affiliated companies, Websites, 
            applications and tools (collectively, “Company” or “we” or “us” or “our”), concerning your access to and use of the:  NFT   [Website URL(s)] Website(s) as well as any other media form, 
            media channel, mobile website or mobile application related or connected thereto (collectively, the “Sites”). The Sites provide the following service: registration, user application, data provide, data verification, 
            data management (“Company Services”). Supplemental terms and conditions or documents that may be posted on the Sites from time to time, are hereby expressly incorporated into this Agreement by reference. 
            </p>

            <p>
            Company makes no representation that the Sites is appropriate or available in other locations other than where it is operated by Company. The information provided on the Sites is not intended for distribution to or 
            use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject Company to any registration requirement within such jurisdiction 
            or country. Accordingly, those persons who choose to access the Sites from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.
            </p>

            <p>Minors (Check one)</p>
            <ul> Users under 18 need permission from a parent or guardian to use the Sites. All users who are minors in the jurisdiction in which they reside 
              (generally under the age of 18) must have the permission of, and be directly supervised by, their parent or guardian to use the Sites. If you are a minor, 
              you must have your parent or guardian read and agree to this Agreement prior to you using the Sites. Persons under the age of 13 (Check one)   ☒   are not   ☐   are permitted to register for the Sites or use the Company Services.
            </ul>           

            <p>YOU ACCEPT AND AGREE TO BE BOUND BY THIS AGREEMENT BY ACKNOWLEDGING SUCH ACCEPTANCE DURING THE REGISTRATION PROCESS (IF APPLICABLE) AND ALSO BY CONTINUING TO USE THE SITES. IF YOU DO NOT AGREE TO ABIDE BY THIS AGREEMENT, 
              OR TO MODIFICATIONS THAT COMPANY MAY MAKE TO THIS AGREEMENT IN THE FUTURE, DO NOT USE OR ACCESS OR CONTINUE TO USE OR ACCESS THE COMPANY SERVICES OR THE SITES.</p>

            <h3>PURCHASES; PAYMENT (Check one)</h3>

            <ul> Company sells products or services.</ul>

            <p>Company may offer free trial or sample of our products or services. 
              The duration of the free trial period and all other details of the offer will be posted on our Sites If you wish to try our free options please read through them carefully first. 
              Company will bill you through a/an: (Check one) ☐   online billing account   ☐   invoice   ☒   payment provider   ☒   other: __________________ ___________________ for our Services. 
              By using our paid options, you agree to pay Company all charges at the prices then in effect for the products or services you or other persons using your billing account may purchase, 
              and you authorize Company to charge your chosen payment provider for any such purchases. You agree to make payment using that selected payment method. If you have ordered a product or service that is subject to recurring charges then you agree to us charging your payment method on a recurring basis, without requiring your prior approval from you for each recurring charge until such time as you cancel the applicable product or service. Company reserves the right to correct any errors or mistakes in pricing that it makes even if it has already requested or received payment. Sales tax will be added to the sales price of purchases as deemed required by Company. Company may change prices at any time. All payments shall be in U.S. dollars, or Crypto coins.
            </p>

            <p>Refund and Return (Check one)</p>
            <ul>  All sales are final and no refunds shall be issued.=</ul>

            <h3>USER REPRESENTATIONS</h3>

            <h4>Regarding Your Registration</h4>

            <p>By using the Company Services, you represent and warrant that: </p>

            <ul>all registration information you submit is truthful and accurate</ul>
            <ul>you will maintain the accuracy of such information</ul>
            <ul>you will keep your password confidential and will be responsible for all use of your password and account</ul>
            <ul>you are not a minor in the jurisdiction in which you reside, or if a minor, you have received parental permission to use our Sites; and</ul>
            <ul>your use of the Company Services does not violate any applicable law or regulation.</ul>
            ...
            Regarding Content You Provide (ADVERTISING AND TWITTER SPACES OR ADDS)
            ...
            B. you are the creator and owner of or have the necessary licenses, rights, consents, releases and permissions to use and to authorize Company and the Sites’ users to use your Contributions as necessary to exercise the licenses granted by you under this Agreement;
            ...
            You may not access or use the Sites for any other purpose other than that for which Company makes it available. The Sites may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by Company. Prohibited activity includes, but is not limited to:
            ...
            ☒   using any information obtained from the Sites in order to harass, abuse, or harm another person 
            ☒   using the Company Services as part of any effort to compete with Company or to provide services as a service bureau 
            ☒   using the Sites in a manner inconsistent with any and all applicable laws and regulations
            ☐   other: _________________________________________________________________________
            __________________________________________________________________________________________________________________________________________________________________

            INTELLECTUAL PROPERTY RIGHTS

            The content on the Sites (“Company Content”) and the trademarks, service marks and logos contained therein (“Marks”) are owned by or licensed to Company, and are subject to copyright and other intellectual property rights under United States and foreign laws and international conventions. Company Content, includes, without limitation, all source code, databases, functionality, software, Sites’ designs, audio, video, text, photographs and graphics. All Company graphics, logos, designs, page headers, button icons, scripts and service names are registered trademarks, common law trademarks or trade dress of Company in the United States and/or other countries. Company trademarks and trade dress may not be used, including as part of trademarks and/or as part of domain names, in connection with any product or service in any manner that is likely to cause confusion and may not be copied, imitated, or used, in whole or in part, without the prior written permission of the Company.
            ...
            DIGITAL MILLENNIUM COPYRIGHT ACT (DMCA) NOTICE AND POLICY (Check one)

            ☒   Not applicable.

            ☐   Company has a designated Copyright Agent.
            ...
            Copyright Agent Name: __________________________ (“Company”)
            ...
            IN NO EVENT SHALL COMPANY OR ITS DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SITES OR COMPANY SERVICES, EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, COMPANY’S LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO COMPANY FOR THE COMPANY SERVICES DURING THE PERIOD OF ____________ MONTHS PRIOR TO ANY CAUSE OF ACTION ARISING.
            ...
            ☐ Sites allows users to use electronic signatures. Users are allowed on _____________________________________ [Website name] to transmit and receive valid electronic signatures in the United States under the Electronic Signatures in Global and National Commerce Act (E-Sign Act) of 2000 and the Uniform Electronic Transactions Act (UETA) of 1999 as adopted by individual states. Users’ signatures and identities are not authenticated on _____________________________________ [Website name].
