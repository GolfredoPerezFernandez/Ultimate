...
export const DropdownMenuDemo = (props) => {
  ...
  return (
    <Box className={styles.card}>          
          ...
          >
            <MenuItem>
           {props.userAddress.substring(0, 5).toUpperCase()??"" + '...' + props.userAddress.substring(props.userAddress.length - 3, props.userAddress.length).toUpperCase()??"" }
            </MenuItem>
